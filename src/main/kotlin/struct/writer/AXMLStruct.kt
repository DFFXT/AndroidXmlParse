...
abstract class BaseChunk(var startPosition: Int) : IWrite {
    var type: Short = 0
 ...
 * tag 基类
 */
abstract class BaseTagChunk(startPosition: Int) : BaseChunk(startPosition) {
...
class ChunkFileWriter : BaseChunk(0) {
    companion object {
...
class ChunkStringWriter(startPosition: Int) : BaseChunk(startPosition) {
    companion object {
 ...
 * 系统资源id表
 */
class ChunkSystemResourceIdWriter(startPosition: Int) : BaseChunk(startPosition) {
    companion object {
 ...
 * 开始名称空间区块
 */
class ChunkNamespaceWriter(startPosition: Int, type: Short) : BaseChunk(startPosition) {
    companion object {
...
class ChunkStartTagWriter(startPosition: Int) : BaseTagChunk(startPosition) {
    companion object {
...
class ChunkEndTagWriter(startPosition: Int) : BaseTagChunk(startPosition) {
    companion object {
